...
There's a small log hollowed out with a space just big enough to crawl through directly below where the deku baba was. Type **?{coordinate}-crawl-log** to continue.}

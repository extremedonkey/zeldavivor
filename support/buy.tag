...
{=(item.shield):Shield|vanity|80|A sturdy shield.|1201853062411730995}
{=(item.bottle):Empty Bottle|vanity|50|An empty bottle to store things in.|1201853110725918741}
{=(item.red-potion):Red Potion|consumable|15|Consumable that restores all HP between battles.|1201853149501980672}
{=(item.fairy):Fairy|consumable|300|Will save you in your time of need.|1201853174449979452} 
...
{=(output.error):You have been unable to purchase this item, please check the rupees in your account, that you don't already own this item, that you spelled the item name correctly, and that you have selected an item that is currently for sale}

...
{=(uids):{user(roleids)}}
{=(br.0):1028666361674748015}
{=(br.1):1028667185649954877}
{=(br.2):1028667227433603124}
{=(br.3):1028667267396931695}
{=(br.4):1028667338008035389}
{=(br.5):1028667430102372482}
{=(br.6):1028667620590886983}
{=(br.7):1028667656255066203}
{=(br.8):1028667722281779200}
{=(br.9):1028668084967444591}
{=(br.10):1028668293025894521}
{=(br.11):1028668377696317510}
{=(br.12):1028668485460570152}
{=(br.13):1028668711663583292}
{=(br.14):1028668841045266443}
{=(br.15):1028668877007228928}
...
{=(comment):Item catagories}
{=(comment):list form is... item | category | price | description | related role ID} 
{=(item.{l1}):Unknown item}
{=(item.hat):Hat|vanity|100|A cool hat for cool people|1030916775669415966}
{=(item.gloves):gloves|vanity|300|A pair of nice woolly gloves to wear because it's cold|1030916822591082556}
{=(item.cat):cat|vanity|1000|If you don't love this cat, you are a monster.|1030916872088064111}
{=(item.coffee):coffee|consumable|150|Provides a 50% boost to wages for 15 minutes once drank|1030916929382268950} 
{=(item.vodka):vodka|consumable|125|Alcohol can be fun, however it has it's dangers. On consumption you'll gain an effect, but be weary, it may always be what you want!|1030916986017939587}
{=(item.blahaj):blahaj|effect|250|Owning blahaj motivates you to work harder, earning you a 2% pay rise when working.|1030917031744262254}
...
{=(output.error):You have been unable to purchase this item, please check the funds in your account, that you don't already own this item, and that you have selected an item that is currently for sale}
{=(output.success):Item purchased, it has been added to your inventory}

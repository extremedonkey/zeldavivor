{=(cdRole):1269670036151468032}
{=(cdTime):3600m}
{blacklist(There's no more pots left! Maybe if you wait a while, say... {cdTime}... the owner will buy some more...):{cdRole}}
{override}{silence}
{c:temprole {user(id)} {cdTime} {cdRole}}

{=(uids):{user(roleids)}}
{=(cooldownoff:{if({in({cdRole}):{uids}}==true):false|true}}
